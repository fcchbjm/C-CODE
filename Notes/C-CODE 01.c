...
//	//printf("%d\n", strlen(arr1));//strlen-string length 用来计算字符串长度-是库函数，需要包含头文件<string.h>
//	//printf("%d\n", strlen(arr2));//strlen通过检测'\0'来判断数组结束，由于数组arr2末尾不包含'\0'所以结果为随机值
//	//printf("%d\n", strlen(arr3));//数组arr3通过手动添加'\0'确定数组结束
...
//语句和语句分类
//分为：空语句 表达式语句 函数调⽤语句 复合语句 控制语句
// 控制语句有可分为：
//1. 条件判断语句也叫分⽀语句：if语句、switch语句；
//2. 循环执⾏语句：do while语句、while语句、for语句；
//3. 转向语句：break语句、goto语句、continue语句、return语句。

////int Add(int x, int y)//函数的⼤括号中的代码构成复合语句(复合语句其实就是的代码块)
////{
////	return x + y;
////}
//int main()
...
//	//int b = 0;
//	//a = 20;
//	//b = a + 5;//表达式语句(在表达式的后边加上分号)
//
//	//printf("hello!\n");//函数调⽤语句(函数调⽤的时候，会加上分号)
//	//int ret = Add(2, 3);//函数调⽤语句
//	//printf("ret=%d\n", ret);
//
//	//for (int i = 0; i <= 10; i++)//for循环的循环体的⼤括号中的就是复合语句
//	//{
//	//	printf("hello!\n");
//	//}
//
//	////注释：注释是对代码的说明，编译器会忽略注释，也就是说，注释对实际代码没有影响。好的注释可以帮我们更好的理解代码，但是也不要过度注释
//	////C语言： /*xxxxxx*/  /* 开始注释后，遇到第⼀个 */ 就认为注释结束了 缺点：不能嵌套
//	////C++： //  这是 C99 标准新增的语法，可以注释一行或多行，从双斜杠到⾏尾都属于注释
//	////注意：不管是哪⼀种注释，都不能放在双引号⾥⾯，双引号⾥⾯的注释符号，会成为字符串的⼀部分，解释为普通符号，失去注释作⽤。
//	//int a = 10;/*C的注释风格*/
//	//int b = 20;//C++的注释风格
//	//printf("%d\n", a + b);
//	//printf("// hello /* world */ ");//注释在双引号⾥⾯的注释符号，成为了字符串的⼀部分，一起打印
//	////注意：编译时，注释会被替换:编译时，注释会被替换成⼀个空格，所以 min/* 这⾥是注释*/Value 会变成 min Value ，⽽不是 minValue 。
//
//	return 0;
//}
